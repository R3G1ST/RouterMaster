...
[![Версия](https://img.shields.io/badge/версия-1.6.4--beta71-blue)]()
...
| 🎭 **Темы интерфейса** | Светлая и тёмная темы программы — переключаются в настройках, заголовки окон в цвет темы |
...
> Тема переключается в настройках программы и запоминается.
...
2. **Введите данные роутера** на вкладке «Подключение»: IP, логин `root` и пароль SSH
3. **Отметьте нужные шаги** на вкладке «Что выполнить» (можно несколько):
   - ✅ Обновить все пакеты
   ...
   - ✅ Проверить и обновить ОС (прошивку)
4. **Заполните параметры** на вкладке «Параметры сети»: SSID, пароль Wi-Fi, каналы, прокси-ссылку
5. Нажмите **«ВЫПОЛНИТЬ»** 🚀
...
В настройках нажмите **«Проверить обновление»**:
